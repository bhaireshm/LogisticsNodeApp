...
exports.getAllEcomstringattributevaluepairlist = async (req, res) => {
  try {
...
exports.getEcomstringattributevaluepairlistById = async (req, res) => {
  try {
...
exports.postEcomstringattributevaluepairlist = async (req, res) => {
  try {
    const ecomstringattributevaluepairlist =
...
exports.deleteEcomstringattributevaluepairlistById = async (req, res) => {
  try {
...
exports.putEcomstringattributevaluepairlistById = async (req, res) => {
  try {
